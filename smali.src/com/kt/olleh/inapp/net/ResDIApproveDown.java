  ...
  extends Response
{
  ...
  protected boolean searchValueTag(Node paramNode)
  {
    ...
    do
    {
      ...
      {
        this.mFile_name = getValue(paramNode);
        return true;
      }
    } while (!str.equalsIgnoreCase("mime_type"));
    this.mMime_type = getValue(paramNode);
    return true;
  }
  ...
  {
    this.mFile_name = paramString;
  }
  
  public void setMimeType(String paramString)
  {
    this.mMime_type = paramString;
  }
  ...
  public String toString()
  {
    ...
    Util.addString(localStringBuffer, "file_name", this.mFile_name);
    Util.addString(localStringBuffer, "mime_type", this.mMime_type);
 ...
 * Qualified Name:     com.kt.olleh.inapp.net.ResDIApproveDown
