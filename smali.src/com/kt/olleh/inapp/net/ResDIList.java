  ...
  extends Response
{
  ...
  private boolean setDiList(NodeList paramNodeList)
  {
    ...
    for (;;)
    {
      ...
      if (((Node)localObject).getNodeName().equalsIgnoreCase("row"))
      {
        ...
        ResDIListRecord localResDIListRecord = new ResDIListRecord();
        localResDIListRecord.searchRecordTag((NodeList)localObject);
        getRecord().add(localResDIListRecord);
      }
      i += 1;
    }
  }
  ...
  public void clear()
  {
    ...
    for (;;)
    {
      ...
      ResDIListRecord localResDIListRecord = (ResDIListRecord)this.mRecord.get(i);
      if (localResDIListRecord != null) {
        localResDIListRecord.clear();
      }
      i += 1;
    }
  }
 ...
 * Qualified Name:     com.kt.olleh.inapp.net.ResDIList
